...
namespace xivModdingFramework.Animations.Helpers
{
    public static class SplineCompressedAnimation
    {
        ...
        static float ReadQuantizedFloat(BinaryReader bin, float min, float max, ScalarQuantizationType type)
        {
            float ratio = -1;
            switch (type)
            {
        ...
        static Quaternion ReadQuatPOLAR32(BinaryReader br)
        {
        ...
        static Quaternion ReadQuatTHREECOMP48(BinaryReader br)
        {
        ...
        static ulong Read40BitValue(BinaryReader br)
        {
        ...
        static Quaternion ReadQuatTHREECOMP40(BinaryReader br)
        {
        ...
        static Quaternion ReadQuantizedQuaternion(BinaryReader br, RotationQuantizationType type)
        {
            switch (type)
            {
        ...
        public class SplineTrackQuaternion
        {
            ...
            internal SplineTrackQuaternion(BinaryReader br, RotationQuantizationType quantizationType)
            {
                ...
                Pad(br, GetRotationAlign(quantizationType));
        ...
        public class SplineTrackVector3
        {
            ...
            internal SplineTrackVector3(BinaryReader br, List<FlagOffset> channelTypes, ScalarQuantizationType quantizationType, bool isPosition)
            {
                short numItems = br.ReadInt16();
                Degree = br.ReadByte();
                int knotCount = numItems + Degree + 2;
        ...
        public class TransformMask
        {
            ...
            internal TransformMask(BinaryReader br)
            {
        ...
        public static List<TransformTrack[]> ReadSplineCompressedAnimByteBlock(byte[] animationData, int numTransformTracks, int numBlocks)
        {
            ...
            using (var br = new BinaryReader(new MemoryStream(animationData)))
            {
                for (int blockIndex = 0; blockIndex < numBlocks; blockIndex++)
                {
                    ...
                    for (int i = 0; i < numTransformTracks; i++)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                Pad(br, GetRotationAlign(m.RotationQuantizationType));
        ...
        private static void Pad(BinaryReader br, int align)
        {
