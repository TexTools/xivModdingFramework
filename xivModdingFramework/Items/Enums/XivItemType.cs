...
namespace xivModdingFramework.Items.Enums
{
    ...
    public static class XivWeaponTypes
    {
        public static string GetNiceName(this XivWeaponType type)
        {
            return type switch
            {
                XivWeaponType.Shield => XivStrings.Shields,
                XivWeaponType.Sword => XivStrings.PaladinArms,
                XivWeaponType.Fists => XivStrings.MonkArms,
                XivWeaponType.FistsOff => XivStrings.MonkArms,
                XivWeaponType.FistsGloves => XivStrings.MonkArms,
                XivWeaponType.Axe => XivStrings.WarriorArms,

                XivWeaponType.Lance => XivStrings.DragoonArms,
                XivWeaponType.Bow => XivStrings.BardArms,
                XivWeaponType.BowOff => XivStrings.BardArms,
                XivWeaponType.Wand => XivStrings.BlackMageArms,
                XivWeaponType.Staff => XivStrings.WhiteMageArms,
                XivWeaponType.Broadsword => XivStrings.DarkKnightArms,
                XivWeaponType.Book => XivStrings.SummonerScholarArms,
                XivWeaponType.Daggers => XivStrings.NinjaArms,
                XivWeaponType.DaggersOff => XivStrings.NinjaArms,
                XivWeaponType.Gun => XivStrings.MachinistArms,
                XivWeaponType.GunOff => XivStrings.MachinistArms,
                XivWeaponType.Orrery => XivStrings.AstrologianArms,
                XivWeaponType.OrreryOff => XivStrings.AstrologianArms,
                XivWeaponType.Katana => XivStrings.SamuraiArms,
                XivWeaponType.KatanaOff => XivStrings.SamuraiArms,
                XivWeaponType.Rapier => XivStrings.RedMageArms,
                XivWeaponType.RapierOff => XivStrings.RedMageArms,
                XivWeaponType.Cane => XivStrings.BlueMageArms,
                XivWeaponType.Gunblade => XivStrings.GunbreakerArms,
                XivWeaponType.Glaives => XivStrings.DancerArms,
                XivWeaponType.GlaivesOff => XivStrings.DancerArms,
                XivWeaponType.Nouliths => XivStrings.SageArms,
                XivWeaponType.Scythe => XivStrings.ReaperArms,
                XivWeaponType.Brush => XivStrings.PictomancerArms,
                XivWeaponType.Palette => XivStrings.PictomancerArms,
                XivWeaponType.Twinfangs => XivStrings.ViperArms,
                XivWeaponType.TwinfangsOff => XivStrings.ViperArms,
                XivWeaponType.Whip => XivStrings.Whips,
                XivWeaponType.Saw => XivStrings.CarpenterArms,
                XivWeaponType.ClawHammer => XivStrings.CarpenterArms,
                XivWeaponType.CrossPeinHammer => XivStrings.BlacksmithArms,
                XivWeaponType.File => XivStrings.BlacksmithArms,
                XivWeaponType.RaisingHammer => XivStrings.ArmorerArms,
                XivWeaponType.Pliers => XivStrings.ArmorerArms,
                XivWeaponType.LapidaryHammer => XivStrings.GoldsmithArms,
                XivWeaponType.GrindingWheel => XivStrings.GoldsmithArms,
                XivWeaponType.RoundKnife => XivStrings.LeatherworkerArms,
                XivWeaponType.Awl => XivStrings.LeatherworkerArms,
                XivWeaponType.Needle => XivStrings.WeaverArms,
                XivWeaponType.SpinningWheel => XivStrings.WeaverArms,
                XivWeaponType.Alembic => XivStrings.AlchemistArms,
                XivWeaponType.Mortar => XivStrings.AlchemistArms,
                XivWeaponType.Frypan => XivStrings.CulinarianArms,
                XivWeaponType.CulinaryKnife => XivStrings.CulinarianArms,
                XivWeaponType.Pickaxe => XivStrings.MinerArms,
                XivWeaponType.Sledgehammer => XivStrings.MinerArms,
                XivWeaponType.Hatchet => XivStrings.BotanistArms,
                XivWeaponType.GardenScythe => XivStrings.BotanistArms,
                XivWeaponType.FishingRod => XivStrings.FisherArms,
                XivWeaponType.Gig => XivStrings.FisherArms,
                XivWeaponType.Food => XivStrings.Food,
